      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="mx-auto w-[300px] rounded-md border">
            ...
            />
            <div className="p-4">
              <h1 className="text-lg text-primary font-semibold">Jenifer Lopez</h1>
              <h6 className="mt-3 text-hover font-medium">Founder and CEO, Web Development</h6>
              ...
              <div className="mt-4 flex flex-wrap">
                <div className="w-auto p-1.5">
                  <a href="#">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-primary hover:border-hover">
                      <svg
                        width="8"
                        height="14"
                        viewBox="0 0 8 14"
